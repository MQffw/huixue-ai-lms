...
import { queryPageApi , addApi, queryInfoApi, updateApi, deleteApi, deleteBatchApi} from '@/api/clazz'
...
const deleteByIds = () => {
  ...
  ElMessageBox.confirm('确定删除选中的班级吗?', '提示', {
    ...
    const result = await deleteBatchApi(selectIds.value)
    if (result.code) {
...
<template>
  <div class="page-container">
    <div class="page-header-bar">
      ...
      <div>
        <el-button class="btn-add" @click="addClazz();resetForm(clazzFormRef)">+ 新增班级</el-button>
      ...
      <el-table :data="tableData" border style="width: 100%" fit @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" width="160">
          <template #default="scope">
            <el-button class="btn-edit" size="small" @click="updateClazz(scope.row.id); resetForm(clazzFormRef)">编辑</el-button>
