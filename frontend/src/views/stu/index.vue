...
<template>
  <div class="page-container">
    ...
    <div class="page-header-bar">
      <h2><span class="title-accent"></span>学员管理</h2>
      <div>
        <el-button class="btn-add" @click="addStu();resetForm(stuFormRef)">+ 新增学员</el-button>
    ...
    <div class="table-card">
      <el-table :data="tableData" border style="width: 100%" fit @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="clazzName" label="班级" align="center" width="130"/>
        <el-table-column prop="gender" label="性别" align="center" width="45" >
          <template #default="scope">{{ scope.row.gender == 1 ? '男': '女' }}</template>
        </el-table-column>
        <el-table-column prop="phone" label="手机号" align="center" width="110"/>
        <el-table-column prop="degree" label="学历" align="center" width="55">
        ...
        <el-table-column prop="violationCount" label="违纪次数" align="center" width="50" />
        <el-table-column prop="violationScore" label="违纪扣分" align="center" width="50" />
        <el-table-column prop="updateTime" label="修改时间" align="center"/>
        <el-table-column label="操作" align="center" width="200">
          <template #default="scope">
            <el-button class="btn-edit" size="small" @click="updateStu(scope.row.id);resetForm(stuFormRef)">编辑</el-button>
            <el-button type="danger" size="small" @click="openViolation(scope.row.id)">违纪</el-button>
