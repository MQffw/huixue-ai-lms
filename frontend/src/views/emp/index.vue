  ...
  <div class="page-container">
    <div class="page-header-bar">
      <div class="page-title-group">
        <h2><span class="title-accent"></span>员工管理</h2>
      </div>
      <div>
        <el-button class="btn-add" @click="addEmp"> + 新增员工</el-button>
    ...
    <div class="table-card">
      <el-table :data="empList" border style="width: 100%" fit @selection-change="handleSelectionChange">
        ...
        <el-table-column label="职位" width="80" align="center">
          <template #default="scope">{{ getJobTitle(scope.row.job) }}</template>
        </el-table-column>
        <el-table-column prop="entryDate" label="入职日期" width="110" align="center"></el-table-column>
        <el-table-column prop="updateTime" label="操作时间" align="center"></el-table-column>
        <el-table-column label="操作" align="center" width="160">
          <template #default="scope">
            <el-button size="small" class="btn-edit" @click="handleEdit(scope.row.id)">编辑</el-button>
        ...
        <el-row :gutter="10">
          <el-col :span="24">
            <el-form-item label="工作经历">
              <el-button type="primary" size="small" @click="addExprItem">+ 添加工作经历</el-button>
            </el-form-item>
          </el-col>
        </el-row>
